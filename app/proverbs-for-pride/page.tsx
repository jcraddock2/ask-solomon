...
export const metadata: Metadata = {
  ...
  description: 'Discover what Proverbs says about pride — why it comes before destruction and how to walk in humility. Biblical wisdom on pride, arrogance, and a haughty spirit.',
  ...
  openGraph: {
    ...
    description: 'Pride is the silent destroyer of relationships, leadership, and destiny. Here is what Solomon — the wisest man who ever lived — had to say about it.',
...
const prideProverbs = [
  {
    ...
    insight: 'This is the most quoted verse on pride for good reason — it is the most clearly observable. Solomon did not offer a moral opinion; he described a pattern he had watched play out repeatedly. Pride does not just precede failure occasionally. It is a reliable precursor. The haughty spirit before a fall is a sequence, not an exception.'
  },
  {
    reference: 'Proverbs 11:2',
    verse: 'When pride cometh, then cometh shame: but with the lowly is wisdom.',
    insight: 'Pride and shame are linked. The proud person believes they are above correction, above failure, above needing others. And then the shame comes — often publicly. Meanwhile, the lowly person (not the defeated, but the humble) walks in wisdom. Wisdom and humility travel together.'
  },
  {
    reference: 'Proverbs 13:10',
    verse: 'Only by pride cometh contention: but with the well advised is wisdom.',
    insight: 'Almost every relational conflict can be traced back to pride — someone unwilling to listen, to be wrong, to defer. Solomon says contention comes only from pride. This is a diagnostic: if there is persistent conflict in a relationship or organization, look for the pride.'
  },
  {
    reference: 'Proverbs 29:23',
    verse: 'A man's pride shall bring him low: but honour shall uphold the humble in spirit.',
    insight: 'The proud person strives for honor and loses it. The humble person does not strive for honor — and receives it. Solomon describes a paradox that Jesus would later amplify: whoever exalts himself will be humbled; whoever humbles himself will be exalted. This is not just theology; it is the observable pattern of how life works.'
  },
  {
    reference: 'Proverbs 6:16-17',
    verse: 'These six things doth the Lord hate: yea, seven are an abomination unto him: A proud look...',
    insight: 'A proud look tops God's list of what He finds detestable. Not murder, not theft — a proud look. This tells us something about how seriously God views pride. It is not a minor personality flaw. It is a posture of the heart that displaces God from His proper position.'
  },
  {
    reference: 'Proverbs 15:33',
    verse: 'The fear of the Lord is the instruction of wisdom; and before honour is humility.',
    insight: 'Humility is not optional for anyone who wants wisdom or honor. It is the prerequisite. Before honor — not after, not alongside. The sequence matters: first humility, then honor. Every shortcut around humility bypasses the very thing that makes honor meaningful and stable.'
  },
]
    ...
    <main className="min-h-screen bg-amber-50">
      <section className="bg-gradient-to-b from-red-900 to-red-800 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-red-100 max-w-2xl mx-auto mb-8">
            Solomon called pride the source of conflict, the precursor to destruction, and the posture God opposes most. Here is why — and what wisdom looks like instead.
          </p>
      ...
      <section className="max-w-4xl mx-auto px-4 py-16">
        <div className="bg-amber-100 border border-amber-300 rounded-xl p-6 mb-10">
          <p className="text-amber-900 text-lg font-medium text-center">
            &ldquo;Pride goeth before destruction, and an haughty spirit before a fall.&rdquo; — Proverbs 16:18
          </p>
        </div>
      ...
      <section className="bg-red-800 text-white py-16 px-4 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-red-100 text-lg mb-8">James 4:6 says God resists the proud but gives grace to the humble. If you want God&apos;s grace flowing through your life — Solomon&apos;s path starts with humility. Ask Solomon what Proverbs says about your specific situation.</p>
          <Link href="/" className="inline-block bg-amber-400 text-red-900 font-bold px-10 py-4 rounded-full text-lg hover:bg-amber-300 transition-colors">Ask Solomon a Question →</Link>
        </div>
      </section>
