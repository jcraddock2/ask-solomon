...
const humilityProverbs = [
  {
    ...
    insight: 'Solomon does not present humility as a consolation prize for those who cannot compete. He presents it as the path to the things most people want â riches, honor, and life. Not through striving and self-promotion, but through humility and reverence for God.'
  },
  {
    reference: 'Proverbs 15:33',
    verse: 'The fear of the Lord is the instruction of wisdom; and before honour is humility.',
    insight: 'Humility is not what you have after you receive honor. It is what you bring before. The sequence is fixed: humility first, then honor. Every attempt to reverse this order â seeking honor before cultivating humility â produces instability at best and destruction at worst.'
  },
  {
    reference: 'Proverbs 11:2',
    verse: 'When pride cometh, then cometh shame: but with the lowly is wisdom.',
    insight: 'Wisdom lives with the lowly â not the impressive, not the credentialed, not the confident. The lowly person is teachable, correctable, and open. These are the conditions in which wisdom can take root and grow. Pride closes the very doors that wisdom needs to enter.'
  },
  {
    reference: 'Proverbs 18:12',
    verse: 'Before destruction the heart of man is haughty, and before honour is humility.',
    insight: 'This is the same principle from two angles: haughtiness precedes destruction, humility precedes honor. Solomon repeats this pattern because he had seen it enough times to call it law. It is not random â it is reliable.'
  },
  {
    reference: 'Proverbs 29:23',
    verse: 'A man's pride shall bring him low: but honour shall uphold the humble in spirit.',
    insight: 'The proud person reaches for elevation and finds themselves lowered. The humble person does not strive â and finds themselves upheld. Honor sustains the humble person in a way that self-promotion never can. What God puts you in, only God needs to keep you in.'
  },
  {
    reference: 'Proverbs 12:15',
    verse: 'The way of a fool is right in his own eyes: but he that hearkeneth unto counsel is wise.',
    insight: 'Humility is not primarily about self-deprecation â it is about teachability. The humble person listens to counsel. The proud person is always right in their own eyes and therefore has nothing to learn. Wisdom requires the posture of a student, not an expert.'
  },
]
    ...
    <main className="min-h-screen bg-amber-50">
      <section className="bg-gradient-to-b from-emerald-900 to-emerald-800 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-emerald-100 max-w-2xl mx-auto mb-8">
            Solomon said before honor is humility â not after. Here is what Proverbs teaches about the posture that opens doors to wisdom, favor, and God&apos;s blessing.
          </p>
      ...
      <section className="max-w-4xl mx-auto px-4 py-16">
        <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-6 mb-10">
          <p className="text-emerald-900 text-lg font-medium text-center">
            &ldquo;By humility and the fear of the Lord are riches, and honour, and life.&rdquo; â Proverbs 22:4
          </p>
        </div>
      ...
      <section className="bg-emerald-800 text-white py-16 px-4 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <Link href="/" className="inline-block bg-amber-400 text-emerald-900 font-bold px-10 py-4 rounded-full text-lg hover:bg-amber-300 transition-colors">Ask Solomon a Question â</Link>
        </div>
      </section>
