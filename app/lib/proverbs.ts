...
const WORD_ALIASES: Record<string, string[]> = {
  ...
  happy: ["hope", "joy", "peace", "encouragement", "happiness", "healing"],
  happiness: ["hope", "joy", "peace", "healing", "encouragement", "happy"],
  depressed: ["hurting", "healing", "hope", "peace", "strength", "discouraged", "depression"],
  depression: ["hurting", "healing", "hope", "peace", "strength", "discouraged", "depressed"],
  forgive: ["healing", "peace", "trust", "hope", "bitterness", "forgiveness"],
  forgiveness: ["healing", "peace", "trust", "hope", "bitterness", "forgive"],
  guilty: ["identity", "healing", "peace", "grace", "forgiveness", "shame"],
  guilt: ["identity", "healing", "peace", "grace", "forgiveness", "shame"],
  pray: ["hope", "peace", "direction", "trust", "healing", "prayer", "wisdom"],
  prayer: ["hope", "peace", "direction", "trust", "healing", "pray", "wisdom"],
