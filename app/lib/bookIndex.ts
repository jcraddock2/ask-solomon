...
export const BOOK_ENTRIES: BookEntry[] = [
...

  {
    ...
    summary: "Solomon points to the ant as the ultimate model of productivity. The ant works without a manager, invests in the future, and does not wait to feel motivated. Three lessons: be industrious, show initiative, and invest for the future. The antidote to laziness is purposeful daily action.",
  ...
  },
  {
    ...
    summary: "Solomon catalogs the sluggard's habits in detail: excuse-making, closed-mindedness, craving sleep, passive desires, neglect, and being overwhelmed by the consequences of that neglect. The remedy is not rest but movement. Activity creates energy. Daily maintenance is easier than recovering from years of neglect.",
  ...
  },
  {
    ...
    summary: "Wise communicators make truth sweet to the hearer. They take responsibility for how they say things, not just what they say. Talk without action is poverty. The wise person teaches their mouth how to speak constructively and productively.",
  ...
  },
  {
    ...
    summary: "A true friend stays in adversity, sharpens you like iron, and speaks from the heart. The wrong friends dull you. People who surround themselves with sour, negative people cannot receive the counsel they need. Iron sharpens iron. Every friendship either sharpens or dulls you. Choose accordingly.",
  ...
  },
  {
    ...
    summary: "Wise people defer their anger, let offenses pass, and stop strife before it escalates. The fool utters everything they feel. The wise person holds it in until afterward. There is no rewind button. Honor comes from ceasing strife, not winning arguments. Self-control is the key to relational peace.",
  ...
  },
  {
    ...
    summary: "The wise mother describes the qualities to look for in a partner: trustworthiness, a strong work ethic, business wisdom, kindness to the poor, good self-esteem, strength of character, wise communication, and a genuine faith. Attraction is not enough. Character is the foundation. Virtue sustains what beauty alone cannot.",
