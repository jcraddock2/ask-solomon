...
export const BOOK_ENTRIES: BookEntry[] = [
  ...
  // --- PURPOSE / DIRECTION / CALLING ---
  {
    ...
    excerpt: "Without a sense of purpose, even great effort feels directionless. Purpose is not found â it is built through faithful action.",
  ...
  // --- TRUST / BETRAYAL / BROKEN RELATIONSHIPS ---
  {
    ...
    excerpt: "Trust is one of the most fragile and essential human currencies. It cannot be rushed â and once broken, it must be rebuilt with patience.",
  ...
  // --- PURPOSE UNDER PRESSURE ---
  {
    ...
    excerpt: "Pressure does not destroy purpose â it reveals it. The things that matter most become clearest under the hardest conditions.",
  ...
  // --- ADDICTION / BAD HABITS / SELF-CONTROL ---
  {
    ...
    excerpt: "Every habit is either building your life or draining it. Wisdom calls you to choose your chains carefully â because you will live in what you repeatedly choose.",
  ...
  // --- GRIEF / LOSS ---
  {
    ...
    excerpt: "Sorrow is not a sign of weakness. It is the soul honoring what mattered. Wisdom does not rush grief â it walks through it with you.",
  ...
  // --- MARRIAGE / DIVORCE / RELATIONSHIP CRISIS ---
  {
    ...
    excerpt: "The strength of any relationship is built not on feelings but on consistent character. Love is not just felt â it is chosen and demonstrated.",
  ...
  // --- WISDOM / DECISION MAKING ---
  {
    ...
    excerpt: "Solomon's greatest possession was not wealth â it was the wisdom that made all other wealth meaningful. Wisdom is available to anyone who asks.",
  ...
  },
  {
    ...
    page: "57",
    title: "Solomon Identified Why People Fail â and Most of It Is Fixable",
  ...
  },
  {
    ...
    page: "227",
    title: "The Eye Is Never Satisfied â But Contentment Is a Choice",
  ...
  // --- SUCCESS / ACHIEVEMENT / WHAT MAKES PEOPLE SUCCESSFUL ---
  {
    id: "success-2",
    chapter: "Success Secrets of Solomon",
    page: "62",
    title: "Solomon Was the Original Success Secret",
    excerpt: "Solomon did not chase success — he asked for wisdom, and success came with it. Every lasting success principle is in Proverbs: diligence, vision, guarding the mind, managing the mouth, choosing the right people, and honoring God first.",
    searchPhrase: "What are the real secrets of success?",
    tags: ["success", "wisdom", "diligence", "vision", "growth"],
    keywords: ["success", "how to succeed", "be successful", "secrets of success", "what makes people successful", "success principles", "path to success", "keys to success", "success mindset", "success habits", "biblical success", "solomon success", "success secrets", "success secrets of solomon", "want to succeed", "achieve goals", "want to win in life", "get ahead", "build a successful life", "what does bible say about success"],
  },

  // --- WEALTH / PROSPERITY / FINANCIAL ABUNDANCE ---
  {
    id: "wealth-1",
    chapter: "Wealth Principles and Generosity",
    page: "96",
    title: "Solomon Built Generational Wealth — and Left the Blueprint",
    excerpt: "Wealth in Solomon's framework is the predictable result of diligence, generosity, and wisdom — not luck. The diligent hand makes rich. Honor God with firstfruits and barns overflow. The contributor grows; the hoarder loses. Desire without knowledge fails every time.",
    searchPhrase: "How do I build real lasting wealth?",
    tags: ["wealth", "prosperity", "abundance", "diligence", "generosity"],
    keywords: ["wealth", "build wealth", "become wealthy", "wealth building", "wealth principles", "biblical wealth", "wealth and prosperity", "prosperity", "how to prosper", "prosperity principles", "financial abundance", "abundance", "wealth mindset", "generational wealth", "how to be prosperous", "what is prosperity", "wealth creation", "money and wealth", "solomon wealth", "solomon prosperity", "proverbs about wealth", "proverbs about prosperity", "financial freedom", "financial independence", "how to get rich", "want to be wealthy"],
  },
