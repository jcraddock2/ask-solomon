                                                                        ...
                                                                        if (mlKey) {
                                                                                                                const emailRes = await fetch("https://connect.mailerlite.com/api/transactional-emails", {
                                                                                                                                                                ...
                                                                                                                                                                body: JSON.stringify({
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        to: [{ email: norm }],
                                                                                                                                                                                                                        subject: "Thank you! Here is your Ask Solomon access link",
                                                                                                                                                                                                                        html: `<div style="font-family:Arial,sans-serif;max-width:480px;margin:0 auto;padding:32px 24px;background:#fff;border-radius:8px"><h2 style="color:#1a1a1a;margin-bottom:8px">Welcome to Ask Solomon Pro!</h2><p style="color:#444;font-size:16px;line-height:1.6">Thank you for your purchase. Click the button below to access the app on any device — no password needed.</p><a href="${link}" style="display:inline-block;margin:24px 0;padding:14px 28px;background:#b8860b;color:#fff;text-decoration:none;border-radius:6px;font-size:16px;font-weight:bold">Access Ask Solomon</a><p style="color:#888;font-size:13px">This link expires in 7 days. After signing in, your browser will remember you for 10 years.</p><p style="color:#888;font-size:13px">Need a new link? Visit <a href="${baseUrl}/login" style="color:#b8860b">${baseUrl}/login</a> anytime.</p></div>`,
                                                                                                                                                                                                                }),
                                                                                                                        });
                                                                                                                if (!emailRes.ok) {
                                                                                                                                                                const errText = await emailRes.text();
                                                                                                                                                                console.error("MailerLite email failed:", emailRes.status, errText);
                                                                                                                        }
                                                                                } else {
