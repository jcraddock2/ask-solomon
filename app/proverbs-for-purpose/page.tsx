...
const purposeProverbs = [
  {
    ...
    insight: 'Vision is not optional. Without it, people do not plateau â they perish. The word in Hebrew means the people become unrestrained, scattered, without direction. Vision is the organizing force of a purposeful life. The absence of it is not neutral; it is erosive.'
  },
  {
    reference: 'Proverbs 16:3',
    verse: 'Commit thy works unto the Lord, and thy thoughts shall be established.',
    insight: 'Purpose is not found by introspection alone â it is established through commitment to God. Commit your works. Not your dreams, not your plans â your actual works, your daily actions. When your hands are committed to God, your thoughts â your direction, your vision â become established.'
  },
  {
    ...
    insight: 'You have many plans, many ideas, many directions you could go. But only one will stand in the end: the counsel of the Lord. This is not discouraging â it is liberating. You do not need to find the perfect plan. You need to find the One whose plan stands.'
  },
  {
    reference: 'Proverbs 16:9',
    verse: 'A man's heart deviseth his way: but the Lord directeth his steps.',
    insight: 'You plan, God directs. Both are true simultaneously. Solomon does not say stop planning â he says acknowledge that the actual path is directed by God. Purpose is a collaboration: you bring your whole heart to it, and you hold it with open hands.'
  },
  {
    ...
    insight: 'The word "direct" here means to make straight or smooth. God does not just point at a direction from a distance â He makes the path clear for those who acknowledge Him in all their ways. Purpose is discovered in relationship, not in isolation.'
  },
  {
    reference: 'Proverbs 20:5',
    verse: 'Counsel in the heart of man is like deep water; but a man of understanding will draw it out.',
    insight: 'Purpose is often already in you â deep, unexamined, not yet articulated. A person of understanding draws it out â through reflection, through wise counsel, through questions that go beneath the surface. The purpose you are looking for may not be absent; it may be deep.'
  },
]
    ...
    <main className="min-h-screen bg-amber-50">
      <section className="bg-gradient-to-b from-violet-900 to-violet-800 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-violet-100 max-w-2xl mx-auto mb-8">
            Solomon said where there is no vision, the people perish. If you are looking for direction, calling, or a sense of what you were made for â here is what Proverbs says.
          </p>
          <Link href="/" className="inline-block bg-amber-400 text-violet-900 font-bold px-8 py-4 rounded-full text-lg hover:bg-amber-300 transition-colors">
            Ask Solomon About Your Purpose â
          </Link>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-4 py-16">
        <div className="bg-violet-50 border border-violet-200 rounded-xl p-6 mb-10">
          <p className="text-violet-900 text-lg font-medium text-center">
            &ldquo;Where there is no vision, the people perish.&rdquo; â Proverbs 29:18
          </p>
        </div>
      ...
      <section className="bg-violet-800 text-white py-16 px-4 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <Link href="/" className="inline-block bg-amber-400 text-violet-900 font-bold px-10 py-4 rounded-full text-lg hover:bg-amber-300 transition-colors">Ask Solomon a Question â</Link>
        </div>
      </section>
