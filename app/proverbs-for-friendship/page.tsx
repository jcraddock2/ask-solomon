...
const friendshipProverbs = [
  {
    ...
    insight: 'The right friendship does not just make you feel good — it makes you better. Iron on iron creates friction, heat, and a sharper edge. If every friendship is frictionless and comfortable, you may be missing the relationships that truly forge you.'
  },
  {
    ...
    insight: 'True friendship is covenantal — it does not leave when things get difficult. Solomon distinguishes between the many acquaintances and the rare friend who is more loyal than blood. That kind of friendship is worth pursuing — and worth being.'
  },
  {
  ...
  },
  {
    ...
    insight: 'The friend who tells you the truth — even when it hurts — is more valuable than the flatterer who tells you what you want to hear. Solomon calls honest correction a wound. Wounds from a trustworthy friend heal. Flattery from an enemy corrupts.'
  },
  {
    reference: 'Proverbs 17:17',
    verse: 'A friend loveth at all times, and a brother is born for adversity.',
    insight: 'Fair-weather friendship is not friendship — it is convenience. Solomon defines true friendship by what it does in hard times. Love at all times. The test of any relationship is what it looks like when things are difficult for you.'
  },
  {
    ...
    insight: 'Avoid close friendship with chronically angry people — not because they are beyond help, but because their spirit is contagious. Solomon understood that habitual proximity to certain behaviors leads to adoption of those behaviors. Guard who you align with.'
  },
  {
    ...
    insight: 'The counsel of a true friend is like a pleasant fragrance — it brings genuine joy. Notice: hearty counsel. Not surface-level advice, but deeply considered wisdom offered in love. This is what friendship is for.'
  },
]
    ...
    <main className="min-h-screen bg-amber-50">
      ...
      <section className="max-w-4xl mx-auto px-4 py-16">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-gray-700 text-lg leading-relaxed mb-6">
            Solomon understood something about human nature that modern psychology has only recently confirmed: the people you spend the most time with shape who you become. Not just your habits and opinions — your character.
          </p>
          <p className="text-gray-700 text-lg leading-relaxed mb-6">
            Proverbs 13:20 is blunt: walk with wise people and wisdom transfers. Companion yourself with fools and destruction follows. This is not a suggestion — Solomon presents it as observable law.
          </p>
          <p className="text-gray-700 text-lg leading-relaxed">
            The question is not whether your relationships are influencing you. They always are. The question is whether that influence is making you wiser, more excellent, and more aligned with God — or not.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-indigo-700 rounded-xl p-6">
              ...
              <p className="text-indigo-100 text-sm">The kisses of an enemy are deceitful. Beware relationships built on empty validation. The person who only tells you what you want to hear is not serving your growth — they are serving themselves.</p>
            </div>
            <div className="bg-indigo-700 rounded-xl p-6">
      ...
      <section className="max-w-4xl mx-auto px-4 py-20 text-center">
        ...
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
          Ask Solomon can find the specific wisdom from Proverbs that speaks to your relationship situation — a difficult friendship, a betrayal, a question about who to trust, or how to be a better friend yourself.
        </p>
        <Link
          href="/"
      ...
      <SevenDaysOptIn topic="Friendship & Relationships" />
